...
L=[3,3,3,3,3,3,5.193,3,5.193];   %length in m
A=[.005,.004,.004,.005,.004,.004,.006,.005,.006];   %Member in number 
...
l8=[4,8,3,7];   %Global labels of member 8
l9=[6,8,5,7];   %Global labels of member 9
...
Tt9=zeros(4);   %Transformation matrix for member 9
...
fem9=[0;0;0;0];  %Local fixed end moments of member 9
rc1 = A./L;
cx = cosd(theta);
cy = sind(theta);
for i =1:n
