...
L=[4.47,6,6.708];   %length in m
A=[1,1,1];   %Member in number 
theta=[56.3,0,-63.4];   %Angle in degrees
...
l1=[8,2,12,6,11,5];   %Global labels of member 1
l2=[2,1,6,4,5,3];   %Global labels of member 2
l3=[1,7,4,10,3,9];   %Global labels of member 2
l=[l1;l2;l3];
dof=uu+ur;   %Degree of freedom
Ktotal=zeros(dof);
Tt1=zeros(6);   %Transformation matrix for member 1
Tt2=zeros(6);   %Transformation matrix for member 2
Tt3=zeros(6);   %Transformation matrix for memb
fem1=[0;0;0;0;0;0];   %Local fixed end moments of member 1
fem2=[26.66;-26.66;20;20;0;0];  %Local fixed end moments of member 2
...
jl=[26.66;-26.66;0;-20;0;-20;0;0;0;0;0;0];   %Values given in kN or kNm
jlu=[26.66;-26.66;0;-20;0;-20];   %Load vector in unrestrained dof
delu=KuuInv*jlu;
