...
L=[3,3,3,4.24,4.24];   %length in m
A=[1,1,1,1,1];   %Member in number 
theta=[0,0,90,45,-45];   %Angle in degrees
uu=5;   %Number of unrestrained degree of freedom
ur=3;   %Number of restrained degree of freedom
uul=[1,2,3,4,5];   %Global labels of unrestrained degree of freedom
url=[6,7,8];   %Global labels of restrained degree of freedom
l1=[6,4,5,3];   %Global labels of member 1
l2=[4,8,3,7];   %Global labels of member 2
l3=[4,2,3,1];   %Global labels of member 3
l4=[6,2,5,1];   %Global labels of member 4
l5=[2,8,1,7];   %Global labels of member 5
l=[l1;l2;l3;l4;l5];
