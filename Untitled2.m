...
L=[4,6,5];   %length in m
A=[];   %Member in number 
theta=[53.13,0];   %Angle in degrees
...
l1=[7,1,8,2,9,3];   %Global labels of member 1
l2=[1,4,2,5,3,6];   %Global labels of member 2
l=[l1;l2];
...
fem2=[26.66;-26.66;40;40;0;0 ];  %Local fixed end moments of member 2
...
jl=[-26.66;-40;15;26.66;-40;0;0;0;0];   %Values given in kN or kNm
jlu=[-26.66;-40;15];   %Load vector in unrestrained dof
delu=KuuInv*jlu;
