...
I=[1,1,1,1,1,1,];   %Moment of inertia in m4
L=[3,3,3,3,4.24,4.24];   %length in m
A=[1,1,1,1,1,1];   %Member in number 
theta=[90,0,-90,-0,45,-45];   %Angle in degrees
...
url=[5,6,7,8];   %Global labels of restrained degree of freedom
l1=[6,2,5,1];   %Global labels of member 1
l2=[2,4,1,3];   %Global labels of member 2
l3=[4,8,3,7];   %Global labels of member 3
l4=[6,8,5,7];   %Global labels of member 4
l5=[6,4,5,3];   %Global labels of member 5
l6=[2,8,1,7];   %Global labels of member 6
